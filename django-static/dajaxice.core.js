...
var Dajaxice = {
	...
	displaylog: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboclient.displaylog', 'POST', callback_function, argv, custom_settings);

	},

	cancellinbocmd: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboclient.cancellinbocmd', 'POST', callback_function, argv, custom_settings);
        },

	linbocmdrunning: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboclient.linbocmdrunning', 'POST', callback_function, argv, custom_settings);
        },

	linbologin: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboclient.linbologin', 'POST', callback_function, argv, custom_settings);
        },

	loadmaindiv: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboclient.loadmaindiv', 'POST', callback_function, argv, custom_settings);

        },

	loadinfodiv: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboclient.loadinfodiv', 'POST', callback_function, argv, custom_settings);

	},

	shell: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboclient.shell', 'POST', callback_function, argv, custom_settings);
    },

	mkcloop: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboclient.mkcloop', 'POST', callback_function, argv, custom_settings);
    },

	upload: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboclient.upload', 'POST', callback_function, argv, custom_settings);
    }
        },
